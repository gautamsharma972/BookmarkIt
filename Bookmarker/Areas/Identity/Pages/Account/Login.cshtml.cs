...
namespace Bookmarker.Areas.Identity.Pages.Account
{
    ...
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<BookmarkerUsers> signInManager, 
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if(_user == null)
                {
                    ModelState.AddModelError(string.Empty, "No Account was found with this Email Id. Try registering!");
                    return Page();
                }
                var result = await _signInManager.PasswordSignInAsync(_user.UserName, Input.Password, Input.RememberMe, lockoutOnFailure: true);
                if (result.Succeeded)
                {
